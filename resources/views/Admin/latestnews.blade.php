		...
		<div class="panel">
			<div class="panel-body">
				...
				<!-- <form  action="{{route('addImageDetail')}}"  method="post" class="form form-horizontal" role="form" enctype="multipart/form-data"> -->
					 ...
					 {!! Form::open(['method' => 'POST','route' => ['latestNewsFormPost'], 'class'=>'form form-horizontal','enctype'=>'multipart/form-data']) !!}
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							{!!Form::select('news_id',$NewsCategory,'',array('id'=>'status','class'=> $errors->has('status') ? 'form-control is-invalid state-invalid' : 'form-control', 'placeholder'=>'--select--', 'autocomplete'=>'off','required'=>'required'))!!} 
